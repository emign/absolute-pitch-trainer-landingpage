...
const de: Dictionary = {
  ...
  features: {
    ...
    list: [
      ...
      {
        icon: "palette",
        title: "Vier handgestimmte Paletten",
        body: "Tube Glow, Jukebox Chrome, Reel-to-Reel, Rainbow Pride. Plus alternative App-Icons.",
      },
      {
        icon: "shield",
  ...
  footer: {
    ...
    copyright: "© 2026 Nicolai Emig. Nicht mit Apple Inc. verbunden.",
    appBy: "Eine App von Nicolai Emig",
